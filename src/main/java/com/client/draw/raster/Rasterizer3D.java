package com.client.draw.raster;
...
public final class Rasterizer3D extends Raster {
    ...
    public static void loadSprites(SpriteLoader spriteLoader) {
        textureCount = 0;
        textureAmount = spriteLoader.sprites.length;
        textures = new Background[textureAmount];
        textureIsTransparant = new boolean[textureAmount];
        averageTextureColours = new int[textureAmount];
        ...
        for (int index = 0; index < textureAmount; index++) {
            try {
                ...
                if(index == 7 || index == 37 || index == 38) {
                	textures[index].resizeHeight = 64;
                	textures[index].resizeWidth = 64;
                } else {
                	textures[index].resizeHeight = 128;
                	textures[index].resizeWidth = 128;
                }
    ...
    public static void drawMaterializedTriangle(int y1, int y2, int y3, int x1, int x2, int x3, int hsl1, int hsl2,
       ...
       if (!Client.enableHDTextures || Texture.get(tex) == null) {
        ...
        ty3 -= ty1;
        tz3 -= tz1;
        int l4 = (tx3 * ty1 - ty3 * tx1) * Rasterizer3D.fieldOfView << 5;
        int i5 = ty3 * tz1 - tz3 * ty1 << 8;
        int j5 = tz3 * tx1 - tx3 * tz1 << 5;
        int k5 = (tx2 * ty1 - ty2 * tx1) * Rasterizer3D.fieldOfView << 5;
        int l5 = ty2 * tz1 - tz2 * ty1 << 8;
        int i6 = tz2 * tx1 - tx2 * tz1 << 5;
        int j6 = (ty2 * tx3 - tx2 * ty3) * Rasterizer3D.fieldOfView << 5;
        ...
        if (y1 <= y2 && y1 <= y3) {
            ...
            if (y2 < y3) {
                ...
                if (y1 != y2 && i8 < i7 || y1 == y2 && i8 > k7) {
                    ...
                    while (--y2 >= 0) {
                        drawMaterializedScanline(Raster.pixels, texels, y1, x3 >> 16, x1 >> 16, hsl3 >> 7,
                    ...
                    while (--y3 >= 0) {
                        drawMaterializedScanline(Raster.pixels, texels, y1, x3 >> 16, x2 >> 16, hsl3 >> 7,
                ...
                y1 = anIntArray1472[y1];
                while (--y2 >= 0) {
                    drawMaterializedScanline(Raster.pixels, texels, y1, x1 >> 16, x3 >> 16, hsl1 >> 7, hsl3 >> 7,
                ...
                while (--y3 >= 0) {
                    drawMaterializedScanline(Raster.pixels, texels, y1, x2 >> 16, x3 >> 16, hsl2 >> 7, hsl3 >> 7,
                            l4, k5, j6, i5, l5, k6, z1, depthSlope);
                    x3 += i8;
                    x2 += k7;
                    z1 += depthScale;
            ...
            if (y1 != y3 && i8 < i7 || y1 == y3 && k7 > i7) {
                ...
                y1 = anIntArray1472[y1];
                while (--y3 >= 0) {
                    drawMaterializedScanline(Raster.pixels, texels, y1, x2 >> 16, x1 >> 16, hsl2 >> 7, hsl1 >> 7,
                            l4, k5, j6, i5, l5, k6, z1, depthSlope);
                    x2 += i8;
                    x1 += i7;
                    z1 += depthScale;
                ...
                while (--y2 >= 0) {
                    drawMaterializedScanline(Raster.pixels, texels, y1, x3 >> 16, x1 >> 16, hsl3 >> 7, hsl1 >> 7,
                            l4, k5, j6, i5, l5, k6, z1, depthSlope);
                    x3 += k7;
                    x1 += i7;
                    z1 += depthScale;
            ...
            y1 = anIntArray1472[y1];
            while (--y3 >= 0) {
                drawMaterializedScanline(Raster.pixels, texels, y1, x1 >> 16, x2 >> 16, hsl1 >> 7, hsl2 >> 7, l4,
            ...
            while (--y2 >= 0) {
                drawMaterializedScanline(Raster.pixels, texels, y1, x1 >> 16, x3 >> 16, hsl1 >> 7, hsl3 >> 7, l4,
                        k5, j6, i5, l5, k6, z1, depthSlope);
                x3 += k7;
                x1 += i7;
                z1 += depthScale;
        ...
        if (y2 <= y3) {
            ...
            if (y3 < y1) {
                ...
                if (y2 != y3 && i7 < k7 || y2 == y3 && i7 > i8) {
                    ...
                    while (--y3 >= 0) {
                        drawMaterializedScanline(Raster.pixels, texels, y2, x1 >> 16, x2 >> 16, hsl1 >> 7,
                    ...
                    while (--y1 >= 0) {
                        drawMaterializedScanline(Raster.pixels, texels, y2, x1 >> 16, x3 >> 16, hsl1 >> 7,
                ...
                y2 = anIntArray1472[y2];
                while (--y3 >= 0) {
                    drawMaterializedScanline(Raster.pixels, texels, y2, x2 >> 16, x1 >> 16, hsl2 >> 7, hsl1 >> 7,
                ...
                while (--y1 >= 0) {
                    drawMaterializedScanline(Raster.pixels, texels, y2, x3 >> 16, x1 >> 16, hsl3 >> 7, hsl1 >> 7,
                            l4, k5, j6, i5, l5, k6, z2, depthSlope);
                    x1 += i7;
                    x3 += i8;
                    z2 += depthScale;
            ...
            if (i7 < k7) {
                ...
                y2 = anIntArray1472[y2];
                while (--y1 >= 0) {
                    drawMaterializedScanline(Raster.pixels, texels, y2, x3 >> 16, x2 >> 16, hsl3 >> 7, hsl2 >> 7,
                            l4, k5, j6, i5, l5, k6, z2, depthSlope);
                    x3 += i7;
                    x2 += k7;
                    z2 += depthScale;
                ...
                while (--y3 >= 0) {
                    drawMaterializedScanline(Raster.pixels, texels, y2, x1 >> 16, x2 >> 16, hsl1 >> 7, hsl2 >> 7,
                            l4, k5, j6, i5, l5, k6, z2, depthSlope);
                    x1 += i8;
                    x2 += k7;
                    z2 += depthScale;
            ...
            y2 = anIntArray1472[y2];
            while (--y1 >= 0) {
                drawMaterializedScanline(Raster.pixels, texels, y2, x2 >> 16, x3 >> 16, hsl2 >> 7, hsl3 >> 7, l4,
            ...
            while (--y3 >= 0) {
                drawMaterializedScanline(Raster.pixels, texels, y2, x2 >> 16, x1 >> 16, hsl2 >> 7, hsl1 >> 7, l4,
                        k5, j6, i5, l5, k6, z2, depthSlope);
                x1 += i8;
                x2 += k7;
                z2 += depthScale;
        ...
        if (y1 < y2) {
            ...
            if (k7 < i8) {
                ...
                while (--y1 >= 0) {
                    drawMaterializedScanline(Raster.pixels, texels, y3, x2 >> 16, x3 >> 16, hsl2 >> 7, hsl3 >> 7,
                ...
                while (--y2 >= 0) {
                    drawMaterializedScanline(Raster.pixels, texels, y3, x2 >> 16, x1 >> 16, hsl2 >> 7, hsl1 >> 7,
                            l4, k5, j6, i5, l5, k6, z3, depthSlope);
                    x2 += k7;
                    x1 += i7;
                    z3 += depthScale;
            ...
            y3 = anIntArray1472[y3];
            while (--y1 >= 0) {
                drawMaterializedScanline(Raster.pixels, texels, y3, x3 >> 16, x2 >> 16, hsl3 >> 7, hsl2 >> 7, l4,
            ...
            while (--y2 >= 0) {
                drawMaterializedScanline(Raster.pixels, texels, y3, x1 >> 16, x2 >> 16, hsl1 >> 7, hsl2 >> 7, l4,
                        k5, j6, i5, l5, k6, z3, depthSlope);
                x2 += k7;
                x1 += i7;
                z3 += depthScale;
        ...
        if (k7 < i8) {
            ...
            y3 = anIntArray1472[y3];
            while (--y2 >= 0) {
                drawMaterializedScanline(Raster.pixels, texels, y3, x1 >> 16, x3 >> 16, hsl1 >> 7, hsl3 >> 7, l4,
                        k5, j6, i5, l5, k6, z3, depthSlope);
                x1 += k7;
                x3 += i8;
                z3 += depthScale;
            ...
            while (--y1 >= 0) {
                drawMaterializedScanline(Raster.pixels, texels, y3, x2 >> 16, x3 >> 16, hsl2 >> 7, hsl3 >> 7, l4,
                        k5, j6, i5, l5, k6, z3, depthSlope);
                x2 += i7;
                x3 += i8;
                z3 += depthScale;
        ...
        y3 = anIntArray1472[y3];
        while (--y2 >= 0) {
            drawMaterializedScanline(Raster.pixels, texels, y3, x3 >> 16, x1 >> 16, hsl3 >> 7, hsl1 >> 7, l4, k5,
        ...
        while (--y1 >= 0) {
            drawMaterializedScanline(Raster.pixels, texels, y3, x3 >> 16, x2 >> 16, hsl3 >> 7, hsl2 >> 7, l4, k5,
                    j6, i5, l5, k6, z3, depthSlope);
            x2 += i7;
            x3 += i8;
            z3 += depthScale;
    ...
    public static void drawLDGouraudTriangle(int y1, int y2, int y3, int x1, int x2, int x3, int hsl1, int hsl2,
        ...
        if (y1 <= y2 && y1 <= y3) {
            ...
            if (y2 < y3) {
                ...
                y2 -= y1;
                for (y1 = anIntArray1472[y1]; --y2 >= 0; y1 += Raster.width) {
                    drawLDGouraudScanline(Raster.pixels, y1, x1 >> 16, x3 >> 16, hsl1 >> 7, hsl3 >> 7, z1,
                            depthSlope);
                    z1 += depthScale;
                    x3 += dx3;
                    x1 += dx1;
                ...
                while (--y3 >= 0) {
                    drawLDGouraudScanline(Raster.pixels, y1, x2 >> 16, x3 >> 16, hsl2 >> 7, hsl3 >> 7, z1,
                            depthSlope);
                    z1 += depthScale;
                    x3 += dx3;
                    x2 += dx2;
            ...
            if (y1 != y3 && dx3 < dx1 || y1 == y3 && dx2 > dx1) {
                ...
                for (y1 = anIntArray1472[y1]; --y3 >= 0; y1 += Raster.width) {
                    drawLDGouraudScanline(Raster.pixels, y1, x2 >> 16, x1 >> 16, hsl2 >> 7, hsl1 >> 7, z1,
                            depthSlope);
                    z1 += depthScale;
                    x2 += dx3;
                    x1 += dx1;
        ...
        if (y2 <= y3) {
            ...
            if (y3 < y1) {
                ...
                y3 -= y2;
                for (y2 = anIntArray1472[y2]; --y3 >= 0; y2 += Raster.width) {
                    drawLDGouraudScanline(Raster.pixels, y2, x2 >> 16, x1 >> 16, hsl2 >> 7, hsl1 >> 7, z2,
                            depthSlope);
                    z2 += depthScale;
                    x1 += dx1;
                    x2 += dx2;
                ...
                while (--y1 >= 0) {
                    drawLDGouraudScanline(Raster.pixels, y2, x3 >> 16, x1 >> 16, hsl3 >> 7, hsl1 >> 7, z2,
                            depthSlope);
                    z2 += depthScale;
                    x1 += dx1;
                    x3 += dx3;
            ...
            if (dx1 < dx2) {
                ...
                for (y2 = anIntArray1472[y2]; --y1 >= 0; y2 += Raster.width) {
                    drawLDGouraudScanline(Raster.pixels, y2, x3 >> 16, x2 >> 16, hsl3 >> 7, hsl2 >> 7, z2,
                            depthSlope);
                    z2 += depthScale;
                    x3 += dx1;
                    x2 += dx2;
        ...
        if (y1 < y2) {
            ...
            if (dx2 < dx3) {
                ...
                for (y3 = anIntArray1472[y3]; --y1 >= 0; y3 += Raster.width) {
                    drawLDGouraudScanline(Raster.pixels, y3, x2 >> 16, x3 >> 16, hsl2 >> 7, hsl3 >> 7, z3,
                            depthSlope);
                    z3 += depthScale;
                    x2 += dx2;
                    x3 += dx3;
                ...
                while (--y2 >= 0) {
                    drawLDGouraudScanline(Raster.pixels, y3, x2 >> 16, x1 >> 16, hsl2 >> 7, hsl1 >> 7, z3,
                            depthSlope);
                    z3 += depthScale;
                    x2 += dx2;
                    x1 += dx1;
    ...
    public static void drawHDGouraudTriangle(int y1, int y2, int y3, int x1, int x2, int x3, int hsl1, int hsl2,
        ...
        if (y1 <= y2 && y1 <= y3) {
            ...
            y3 -= y1;
            for (y1 = anIntArray1472[y1]; --y3 >= 0; y1 += Raster.width) {
                drawHDGouraudScanline(Raster.pixels, y1, x1 >> 16, x2 >> 16, r1, g1, b1, r2, g2, b2, z1,
                        depthSlope);
                x2 += dx3;
                x1 += dx1;
                r2 += dr3;
        ...
        if (y2 <= y3) {
            ...
            y1 -= y2;
            for (y2 = anIntArray1472[y2]; --y1 >= 0; y2 += Raster.width) {
                drawHDGouraudScanline(Raster.pixels, y2, x2 >> 16, x3 >> 16, r2, g2, b2, r3, g3, b3, z2,
                        depthSlope);
                x3 += dx1;
                x2 += dx2;
                r3 += dr1;
        ...
        if (y1 < y2) {
            ...
            y1 -= y3;
            for (y3 = anIntArray1472[y3]; --y1 >= 0; y3 += Raster.width) {
                drawHDGouraudScanline(Raster.pixels, y3, x3 >> 16, x2 >> 16, r3, g3, b3, r2, g2, b2, z3,
                        depthSlope);
                x2 += dx2;
                x3 += dx3;
                r2 += dr2;
            ...
            while (--y2 >= 0) {
                drawHDGouraudScanline(Raster.pixels, y3, x1 >> 16, x2 >> 16, r1, g1, b1, r2, g2, b2, z3,
                        depthSlope);
                x2 += dx2;
                x1 += dx1;
                r2 += dr2;
        ...
        if (dx2 < dx3) {
            ...
            y2 -= y3;
            for (y3 = anIntArray1472[y3]; --y2 >= 0; y3 += Raster.width) {
                drawHDGouraudScanline(Raster.pixels, y3, x1 >> 16, x3 >> 16, r1, g1, b1, r3, g3, b3, z3,
                        depthSlope);
                x1 += dx2;
                x3 += dx3;
                r1 += dr2;
    ...
    public static void drawTexturedTriangle317(int y1, int y2, int y3, int x1, int x2, int x3, int c1, int c2, int c3,
        ...
        t6 -= t4;
        t9 -= t7;
        int l4 = (t3 * t4 - t6 * t1) * Rasterizer3D.fieldOfView << 5;
        int i5 = t6 * t7 - t9 * t4 << 8;
        int j5 = t9 * t1 - t3 * t7 << 5;
        int k5 = (t2 * t4 - t5 * t1) * Rasterizer3D.fieldOfView << 5;
        int l5 = t5 * t7 - t8 * t4 << 8;
        int i6 = t8 * t1 - t2 * t7 << 5;
        int j6 = (t5 * t3 - t2 * t6) * Rasterizer3D.fieldOfView << 5;
        ...
        if (y1 <= y2 && y1 <= y3) {
            ...
            if (y2 < y3) {
                ...
                if (y1 != y2 && i8 < i7 || y1 == y2 && i8 > k7) {
                    ...
                    y1 = anIntArray1472[y1];
                    while (--y2 >= 0) {
                        drawTexturedScanline317(Raster.pixels, texels, y1, x3 >> 16, x1 >> 16, c3 >> 8, c1 >> 8,
                                l4, k5, j6, i5, l5, k6, z1, depthSlope);
                        z1 += depthScale;
                        x3 += i8;
                        x1 += i7;
                    ...
                    while (--y3 >= 0) {
                        drawTexturedScanline317(Raster.pixels, texels, y1, x3 >> 16, x2 >> 16, c3 >> 8, c2 >> 8,
                                l4, k5, j6, i5, l5, k6, z1, depthSlope);
                        z1 += depthScale;
                        x3 += i8;
                        x2 += k7;
                ...
                y1 = anIntArray1472[y1];
                while (--y2 >= 0) {
                    drawTexturedScanline317(Raster.pixels, texels, y1, x1 >> 16, x3 >> 16, c1 >> 8, c3 >> 8, l4,
                            k5, j6, i5, l5, k6, z1, depthSlope);
                    z1 += depthScale;
                    x3 += i8;
                    x1 += i7;
                ...
                while (--y3 >= 0) {
                    drawTexturedScanline317(Raster.pixels, texels, y1, x2 >> 16, x3 >> 16, c2 >> 8, c3 >> 8, l4,
                            k5, j6, i5, l5, k6, z1, depthSlope);
                    z1 += depthScale;
                    x3 += i8;
                    x2 += k7;
            ...
            if (y1 != y3 && i8 < i7 || y1 == y3 && k7 > i7) {
                ...
                y1 = anIntArray1472[y1];
                while (--y3 >= 0) {
                    drawTexturedScanline317(Raster.pixels, texels, y1, x2 >> 16, x1 >> 16, c2 >> 8, c1 >> 8, l4,
                            k5, j6, i5, l5, k6, z1, depthSlope);
                    z1 += depthScale;
                    x2 += i8;
                    x1 += i7;
                ...
                while (--y2 >= 0) {
                    drawTexturedScanline317(Raster.pixels, texels, y1, x3 >> 16, x1 >> 16, c3 >> 8, c1 >> 8, l4,
                            k5, j6, i5, l5, k6, z1, depthSlope);
                    z1 += depthScale;
                    x3 += k7;
                    x1 += i7;
            ...
            y1 = anIntArray1472[y1];
            while (--y3 >= 0) {
                drawTexturedScanline317(Raster.pixels, texels, y1, x1 >> 16, x2 >> 16, c1 >> 8, c2 >> 8, l4, k5,
            ...
            while (--y2 >= 0) {
                drawTexturedScanline317(Raster.pixels, texels, y1, x1 >> 16, x3 >> 16, c1 >> 8, c3 >> 8, l4, k5,
                        j6, i5, l5, k6, z1, depthSlope);
                z1 += depthScale;
                x3 += k7;
                x1 += i7;
        ...
        if (y2 <= y3) {
            ...
            if (y3 < y1) {
                ...
                if (y2 != y3 && i7 < k7 || y2 == y3 && i7 > i8) {
                    ...
                    y2 = anIntArray1472[y2];
                    while (--y3 >= 0) {
                        drawTexturedScanline317(Raster.pixels, texels, y2, x1 >> 16, x2 >> 16, c1 >> 8, c2 >> 8,
                                l4, k5, j6, i5, l5, k6, z2, depthSlope);
                        z2 += depthScale;
                        x1 += i7;
                        x2 += k7;
                    ...
                    while (--y1 >= 0) {
                        drawTexturedScanline317(Raster.pixels, texels, y2, x1 >> 16, x3 >> 16, c1 >> 8, c3 >> 8,
                                l4, k5, j6, i5, l5, k6, z2, depthSlope);
                        z2 += depthScale;
                        x1 += i7;
                        x3 += i8;
                ...
                y2 = anIntArray1472[y2];
                while (--y3 >= 0) {
                    drawTexturedScanline317(Raster.pixels, texels, y2, x2 >> 16, x1 >> 16, c2 >> 8, c1 >> 8, l4,
                            k5, j6, i5, l5, k6, z2, depthSlope);
                    z2 += depthScale;
                    x1 += i7;
                    x2 += k7;
                ...
                while (--y1 >= 0) {
                    drawTexturedScanline317(Raster.pixels, texels, y2, x3 >> 16, x1 >> 16, c3 >> 8, c1 >> 8, l4,
                            k5, j6, i5, l5, k6, z2, depthSlope);
                    z2 += depthScale;
                    x1 += i7;
                    x3 += i8;
            ...
            if (i7 < k7) {
                ...
                y2 = anIntArray1472[y2];
                while (--y1 >= 0) {
                    drawTexturedScanline317(Raster.pixels, texels, y2, x3 >> 16, x2 >> 16, c3 >> 8, c2 >> 8, l4,
                            k5, j6, i5, l5, k6, z2, depthSlope);
                    z2 += depthScale;
                    x3 += i7;
                    x2 += k7;
                ...
                while (--y3 >= 0) {
                    drawTexturedScanline317(Raster.pixels, texels, y2, x1 >> 16, x2 >> 16, c1 >> 8, c2 >> 8, l4,
                            k5, j6, i5, l5, k6, z2, depthSlope);
                    z2 += depthScale;
                    x1 += i8;
                    x2 += k7;
            ...
            y2 = anIntArray1472[y2];
            while (--y1 >= 0) {
                drawTexturedScanline317(Raster.pixels, texels, y2, x2 >> 16, x3 >> 16, c2 >> 8, c3 >> 8, l4, k5,
            ...
            while (--y3 >= 0) {
                drawTexturedScanline317(Raster.pixels, texels, y2, x2 >> 16, x1 >> 16, c2 >> 8, c1 >> 8, l4, k5,
                        j6, i5, l5, k6, z2, depthSlope);
                z2 += depthScale;
                x1 += i8;
                x2 += k7;
        ...
        if (y1 < y2) {
            ...
            if (k7 < i8) {
                ...
                y3 = anIntArray1472[y3];
                while (--y1 >= 0) {
                    drawTexturedScanline317(Raster.pixels, texels, y3, x2 >> 16, x3 >> 16, c2 >> 8, c3 >> 8, l4,
                            k5, j6, i5, l5, k6, z3, depthSlope);
                    z3 += depthScale;
                    x2 += k7;
                    x3 += i8;
                ...
                while (--y2 >= 0) {
                    drawTexturedScanline317(Raster.pixels, texels, y3, x2 >> 16, x1 >> 16, c2 >> 8, c1 >> 8, l4,
                            k5, j6, i5, l5, k6, z3, depthSlope);
                    z3 += depthScale;
                    x2 += k7;
                    x1 += i7;
            ...
            y3 = anIntArray1472[y3];
            while (--y1 >= 0) {
                drawTexturedScanline317(Raster.pixels, texels, y3, x3 >> 16, x2 >> 16, c3 >> 8, c2 >> 8, l4, k5,
                        j6, i5, l5, k6, z3, depthSlope);
                z3 += depthScale;
                x2 += k7;
                x3 += i8;
            ...
            while (--y2 >= 0) {
                drawTexturedScanline317(Raster.pixels, texels, y3, x1 >> 16, x2 >> 16, c1 >> 8, c2 >> 8, l4, k5,
                        j6, i5, l5, k6, z3, depthSlope);
                z3 += depthScale;
                x2 += k7;
                x1 += i7;
        ...
        if (k7 < i8) {
            ...
            y3 = anIntArray1472[y3];
            while (--y2 >= 0) {
                drawTexturedScanline317(Raster.pixels, texels, y3, x1 >> 16, x3 >> 16, c1 >> 8, c3 >> 8, l4, k5,
                        j6, i5, l5, k6, z3, depthSlope);
                z3 += depthScale;
                x1 += k7;
                x3 += i8;
            ...
            while (--y1 >= 0) {
                drawTexturedScanline317(Raster.pixels, texels, y3, x2 >> 16, x3 >> 16, c2 >> 8, c3 >> 8, l4, k5,
                        j6, i5, l5, k6, z3, depthSlope);
                z3 += depthScale;
                x2 += i7;
                x3 += i8;
        ...
        y3 = anIntArray1472[y3];
        while (--y2 >= 0) {
            drawTexturedScanline317(Raster.pixels, texels, y3, x3 >> 16, x1 >> 16, c3 >> 8, c1 >> 8, l4, k5, j6,
        ...
        while (--y1 >= 0) {
            drawTexturedScanline317(Raster.pixels, texels, y3, x3 >> 16, x2 >> 16, c3 >> 8, c2 >> 8, l4, k5, j6,
                    i5, l5, k6, z3, depthSlope);
            z3 += depthScale;
            x2 += i7;
            x3 += i8;
    ...
    public static void drawTexturedTriangleOSRS(int var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11, int var12, int var13, int var14, int var15, int var16, int var17, int var18) {
    ...
    public static void drawTexturedTriangleOld(int y1, int y2, int y3, int x1, int x2, int x3, int c1, int c2, int c3,
        ...
        int texels[] = getTexturePixels(tex);
        if(texels == null) {
        	drawGouraudTriangle(y1, y2, y3, x1, x2, x3, c1, c2, c3, z1, z2, z3);
        	return;
        }
        aBoolean1463 = !textureIsTransparant[tex];
        tx2 = tx1 - tx2;
        ...
        if (y1 <= y2 && y1 <= y3) {
            ...
            if (y2 < y3) {
                ...
                if (y1 != y2 && i8 < i7 || y1 == y2 && i8 > k7) {
                    ...
                    y1 = anIntArray1472[y1];
                    while (--y2 >= 0) {
                        drawTexturedScanline(Raster.pixels, texels, y1, x3 >> 16, x1 >> 16, c3, c1, l4, k5, j6, i5,
                                l5, k6, z1, depthSlope);
                        z1 += depthScale;
                        x3 += i8;
                        x1 += i7;
                    ...
                    while (--y3 >= 0) {
                        drawTexturedScanline(Raster.pixels, texels, y1, x3 >> 16, x2 >> 16, c3, c2, l4, k5, j6, i5,
                                l5, k6, z1, depthSlope);
                        z1 += depthScale;
                        x3 += i8;
                        x2 += k7;
                ...
                y1 = anIntArray1472[y1];
                while (--y2 >= 0) {
                    drawTexturedScanline(Raster.pixels, texels, y1, x1 >> 16, x3 >> 16, c1, c3, l4, k5, j6, i5, l5,
                            k6, z1, depthSlope);
                    z1 += depthScale;
                    x3 += i8;
                    x1 += i7;
                ...
                while (--y3 >= 0) {
                    drawTexturedScanline(Raster.pixels, texels, y1, x2 >> 16, x3 >> 16, c2, c3, l4, k5, j6, i5, l5,
                            k6, z1, depthSlope);
                    z1 += depthScale;
                    x3 += i8;
                    x2 += k7;
            ...
            if (y1 != y3 && i8 < i7 || y1 == y3 && k7 > i7) {
                ...
                y1 = anIntArray1472[y1];
                while (--y3 >= 0) {
                    drawTexturedScanline(Raster.pixels, texels, y1, x2 >> 16, x1 >> 16, c2, c1, l4, k5, j6, i5, l5,
                            k6, z1, depthSlope);
                    z1 += depthScale;
                    x2 += i8;
                    x1 += i7;
            ...
            y1 = anIntArray1472[y1];
            while (--y3 >= 0) {
                drawTexturedScanline(Raster.pixels, texels, y1, x1 >> 16, x2 >> 16, c1, c2, l4, k5, j6, i5, l5, k6,
                        z1, depthSlope);
                z1 += depthScale;
                x2 += i8;
                x1 += i7;
        ...
        if (y2 <= y3) {
            ...
            if (y3 < y1) {
                ...
                if (y2 != y3 && i7 < k7 || y2 == y3 && i7 > i8) {
                    ...
                    y2 = anIntArray1472[y2];
                    while (--y3 >= 0) {
                        drawTexturedScanline(Raster.pixels, texels, y2, x1 >> 16, x2 >> 16, c1, c2, l4, k5, j6, i5,
                                l5, k6, z2, depthSlope);
                        z2 += depthScale;
                        x1 += i7;
                        x2 += k7;
                    ...
                    while (--y1 >= 0) {
                        drawTexturedScanline(Raster.pixels, texels, y2, x1 >> 16, x3 >> 16, c1, c3, l4, k5, j6, i5,
                                l5, k6, z2, depthSlope);
                        z2 += depthScale;
                        x1 += i7;
                        x3 += i8;
                ...
                y2 = anIntArray1472[y2];
                while (--y3 >= 0) {
                    drawTexturedScanline(Raster.pixels, texels, y2, x2 >> 16, x1 >> 16, c2, c1, l4, k5, j6, i5, l5,
                            k6, z2, depthSlope);
                    z2 += depthScale;
                    x1 += i7;
                    x2 += k7;
                ...
                while (--y1 >= 0) {
                    drawTexturedScanline(Raster.pixels, texels, y2, x3 >> 16, x1 >> 16, c3, c1, l4, k5, j6, i5, l5,
                            k6, z2, depthSlope);
                    z2 += depthScale;
                    x1 += i7;
                    x3 += i8;
            ...
            if (i7 < k7) {
                ...
                y2 = anIntArray1472[y2];
                while (--y1 >= 0) {
                    drawTexturedScanline(Raster.pixels, texels, y2, x3 >> 16, x2 >> 16, c3, c2, l4, k5, j6, i5, l5,
                            k6, z2, depthSlope);
                    z2 += depthScale;
                    x3 += i7;
                    x2 += k7;
            ...
            y2 = anIntArray1472[y2];
            while (--y1 >= 0) {
                drawTexturedScanline(Raster.pixels, texels, y2, x2 >> 16, x3 >> 16, c2, c3, l4, k5, j6, i5, l5, k6,
                        z2, depthSlope);
                z2 += depthScale;
                x3 += i7;
                x2 += k7;
        ...
        if (y1 < y2) {
            ...
            if (k7 < i8) {
                ...
                y3 = anIntArray1472[y3];
                while (--y1 >= 0) {
                    drawTexturedScanline(Raster.pixels, texels, y3, x2 >> 16, x3 >> 16, c2, c3, l4, k5, j6, i5, l5,
                            k6, z3, depthSlope);
                    z3 += depthScale;
                    x2 += k7;
                    x3 += i8;
                ...
                while (--y2 >= 0) {
                    drawTexturedScanline(Raster.pixels, texels, y3, x2 >> 16, x1 >> 16, c2, c1, l4, k5, j6, i5, l5,
                            k6, z3, depthSlope);
                    z3 += depthScale;
                    x2 += k7;
                    x1 += i7;
            ...
            y3 = anIntArray1472[y3];
            while (--y1 >= 0) {
                drawTexturedScanline(Raster.pixels, texels, y3, x3 >> 16, x2 >> 16, c3, c2, l4, k5, j6, i5, l5, k6,
                        z3, depthSlope);
                z3 += depthScale;
                x2 += k7;
                x3 += i8;
            ...
            while (--y2 >= 0) {
                drawTexturedScanline(Raster.pixels, texels, y3, x1 >> 16, x2 >> 16, c1, c2, l4, k5, j6, i5, l5, k6,
                        z3, depthSlope);
                z3 += depthScale;
                x2 += k7;
                x1 += i7;
        ...
        if (k7 < i8) {
            ...
            y3 = anIntArray1472[y3];
            while (--y2 >= 0) {
                drawTexturedScanline(Raster.pixels, texels, y3, x1 >> 16, x3 >> 16, c1, c3, l4, k5, j6, i5, l5, k6,
                        z3, depthSlope);
                z3 += depthScale;
                x1 += k7;
                x3 += i8;
