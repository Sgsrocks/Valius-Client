...
public class ModelLoader {
    ...
    public static void decodeType3(Model def, byte[] var1)
    {
        ...
        int numVertices = var2.readUShort();
        int numTriangles = var2.readUShort();
        ...
        def.verticesParticle = new int[numVertices];
        if (var17 == 1)
        {
            def.vertexData = new int[numVertices];
        }

        if (var12 == 1)
        {
            def.types = new int[numTriangles];
        }

        if (var13 == 255)
        {
            def.face_render_priorities = new byte[numTriangles];
        }
        else
        {
        ...
        if (var15 == 1)
        {
            def.triangleData = new int[numTriangles];
        }

        if (var16 == 1)
        {
            def.materials = new short[numTriangles];
        }

        if (var16 == 1 && var11 > 0)
        {
            def.textures = new byte[numTriangles];
        }

        if (var18 == 1)
        {
            def.animayaGroups = new int[numVertices][];
            def.animayaScales = new int[numVertices][];
        }
        ...
        int var54;
        int var55;
        for (var51 = 0; var51 < numVertices; ++var51)
        {
        ...
        for (var51 = 0; var51 < numTriangles; ++var51)
        {
        ...
        int var56;
        for (var55 = 0; var55 < numTriangles; ++var55)
        {
    ...
    public static void decodeType2(Model def, byte[] var1)
    {
        ...
        int numVertices = var4.readUShort();
        int numTriangles = var4.readUShort();
        numVertices = ModelHeader.kll(numVertices);
        numTriangles = ModelHeader.kll455(numTriangles);
        numVertices = ModelHeader.err(numVertices);
        numTriangles = ModelHeader.err(numTriangles);
        ...
        int var43;
        int var44;
        for (var40 = 0; var40 < numVertices; ++var40)
        {
        ...
        for (var40 = 0; var40 < numTriangles; ++var40)
        {
        ...
        int var45;
        int var46;
        for (var44 = 0; var44 < numTriangles; ++var44)
        {
        ...
        if (def.textures != null)
        {
            ...
            for (var45 = 0; var45 < numTriangles; ++var45)
            {
    ...
    public static void decodeType1(Model def, byte[] var1)
    {
        ...
        int var52;
        int var53;
        for (var49 = 0; var49 < numVertices; ++var49)
        {
        ...
        for (var49 = 0; var49 < numTriangles; ++var49)
        {
        ...
        int var54;
        for (var53 = 0; var53 < numTriangles; ++var53)
        {
    ...
    public static void decodeOldFormat(Model def, byte[] var1)
    {
        ...
        int var41;
        int var42;
        for (var38 = 0; var38 < numVertices; ++var38)
        {
        ...
        for (var38 = 0; var38 < numTriangles; ++var38)
        {
        ...
        int var43;
        int var44;
        for (var42 = 0; var42 < numTriangles; ++var42)
        {
        ...
        if (def.textures != null)
        {
            ...
            for (var43 = 0; var43 < numTriangles; ++var43)
            {
