...
public class Projectile extends Renderable {
	...
	public Model getRotatedModel() {
		...
		if (aSpotAnim_1592.animation != null)
			j = aSpotAnim_1592.animation.primaryFrames[anInt1593];
		...
		if (aSpotAnim_1592.breadthScale != 128 || aSpotAnim_1592.depthScale != 128)
			model_1.method478(aSpotAnim_1592.breadthScale, aSpotAnim_1592.breadthScale,
					aSpotAnim_1592.depthScale);
		model_1.method474(anInt1596);
		model_1.light(64 + aSpotAnim_1592.ambience,
				850 + aSpotAnim_1592.modelShadow, -30, -50, -30, true);
		return model_1;
	}
	...
	public Projectile(int i, int j, int l, int i1, int j1, int k1, int l1,
		...
		aBoolean1579 = false;
		aSpotAnim_1592 = GraphicsDefinition.forId(l2);
		anInt1597 = k1;
		anInt1580 = j2;
		anInt1581 = i2;
		anInt1582 = l1;
	...
	public void method456(int i) {
		...
		if(aSpotAnim_1592 == null)
			return;
		if (aSpotAnim_1592.animation != null)
			for (anInt1594 += i; anInt1594 > aSpotAnim_1592.animation
					.method258(anInt1593);) {
				anInt1594 -= aSpotAnim_1592.animation.method258(anInt1593) + 1;
				anInt1593++;
