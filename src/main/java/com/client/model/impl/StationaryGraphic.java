...
public class StationaryGraphic extends Renderable {

	public StationaryGraphic(int i, int j, int l, int i1, int j1, int k1, int l1) {
		aBoolean1567 = false;
		aSpotAnim_1568 = GraphicsDefinition.forId(i1);
		anInt1560 = i;
		anInt1561 = l1;
		anInt1562 = k1;
		anInt1563 = j1;
	...
	public Model getRotatedModel() {
		...
		if (model == null)
			return null;
		int j = aSpotAnim_1568.animation.primaryFrames[anInt1569];
		...
		if (aSpotAnim_1568.breadthScale != 128 || aSpotAnim_1568.depthScale != 128)
			model_1.method478(aSpotAnim_1568.breadthScale, aSpotAnim_1568.breadthScale,
					aSpotAnim_1568.depthScale);
		...
		model_1.light(64 + aSpotAnim_1568.ambience,
	...
	public void method454(int i) {
		if(aSpotAnim_1568 == null)
			return;
		for (anInt1570 += i; anInt1570 > aSpotAnim_1568.animation.method258(anInt1569); ) {
			anInt1570 -= aSpotAnim_1568.animation.method258(anInt1569) + 1;
			anInt1569++;
			if (anInt1569 >= aSpotAnim_1568.animation.frameCount
					&& (anInt1569 < 0 || anInt1569 >= aSpotAnim_1568.animation.frameCount)) {
				anInt1569 = 0;
				aBoolean1567 = true;
			}
		}
