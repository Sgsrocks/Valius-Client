...
public final class Player extends Entity {
		...
		if (super.anInt1520 != -1 && super.anInt1521 != -1) {
			...
			if(spotAnim != null) {
				...
				if (model_2 != null) {
					...
					model_3.light(84 + spotAnim.ambience,
	...
	public Model method452() {
				...
				if (i3 >= 512) {
					...
					if (model_4 != null) {
						if(colourFind[l2] != null) {
							Model model_5 = new Model(1, new Model[] {model_4}, true);
							for(int i = 0;i<colourFind[l2].length;i++)
								model_5.recolor(colourFind[l2][i], colourReplace[l2][i]);
		...
		model_2.replace(model_1, Frame.method532(k) & Frame.method532(i1));
		if (k != -1 && i1 != -1)
			model_2.method471(AnimationDefinition.anims[super.anim].interleaveOrder, i1, k);
		else if (k != -1)
			model_2.method470(k);
		model_2.calc_diagonals();
	...
	public Model method453() {
			...
			if (i1 >= 512) {
				...
				if (model_2 != null) {
					if (colourFind[l] != null) {
						Model model_5 = new Model(1, new Model[] { model_2 }, true);
						for (int i = 0; i < colourFind[l].length; i++)
							model_5.recolor(colourFind[l][i], colourReplace[l][i]);
		...
		Model model = new Model(k, aclass30_sub2_sub4_sub6s, true);
